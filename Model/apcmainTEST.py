...
if __name__ == '__main__':
    try:
        ...
        url =  'http://192.168.156.27:8080/AILab/python/modlebuild/4.do'  # sys.argv[1]
        ...
        resp_opc = requests.get("http://192.168.156.27:8080/AILab/python/opcread/%d.do" % modleId)
        ...
        while ((isEnable == 1) and (realvalidekey == modlevalidekey)):
            ...
            print(payload)
            write_resp ="" #requests.post("http://192.168.156.27:8080/AILab/python/updateModleData.do", data=payload)
            if DEBUG:
                print(write_resp.text)
    except:
        traceback.print_exc()
