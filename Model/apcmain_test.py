...
if __name__ == '__main__':
    ...
    url = 'http://192.168.156.27:8080/AILab/python/modlebuild/1.do'  # sys.argv[1]
    modleId = 1#int(sys.argv[2])
    ...
    while ((isEnable == 1) and (realvalidekey == modlevalidekey)):
        ...
        write_resp = requests.post("http://192.168.156.27:8080/AILab/python/opcwrite.do", params=payload)
        if DEBUG:
